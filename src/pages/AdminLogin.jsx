...
export default function AdminLogin() {
    ...
    const validateForm = () => {
        const newErrors = {};
        if (isSignUp && !formData.email.includes('@admin.')) {
            newErrors.email = 'Admin email must contain @admin. domain';
        }
    ...
    return (
        <div className="login-wrapper">
            <div className="login-card" onKeyPress={handleKeyPress}>
                ...
                <input type="email" placeholder="Admin Email (@admin.domain)" value={formData.email} onChange={(e) => handleInputChange('email', e.target.value)} onKeyPress={handleKeyPress} className={errors.email ? 'error' : ''} />
